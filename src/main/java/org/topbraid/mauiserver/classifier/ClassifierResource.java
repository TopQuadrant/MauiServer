 ...
 * GET /classifier/myClassifier (body=myInstanceData) -> TTL of result node, e.g. "ex:Male"
 * DELETE /classifier/myClassifier -> OK
 * 
 * @author Holger Knublauch
 */
public class ClassifierResource extends Resource implements Deletable, Gettable, Puttable {
